...
public class CaseRunner4_2 {
    ...
    public static void main0(String[] args) throws Exception {
        ...
        traceIdDiff = argc >= 1 ? Integer.parseInt(args[0]) : 3;
        expectedOperationName = argc >= 2 ? args[1] : "sendSms";
        sampleInterval = argc >= 3 ? Integer.parseInt(args[2]) : 10;
    ...
    private static Runnable createTask(InputStream in, int sampleInterval,
        ...
        taskClazz = null == taskClazz ? "io.github.viscent.mtia.ch4.case02.MultithreadedStatTask" : taskClazz;
